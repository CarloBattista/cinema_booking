<template>
    <div class="relative w-full">
        ...
        <label :for="forInput" class="absolute left-6 font-normal transition-all duration-300" :class="{ 'text-[#9FA3A6] text-xs top-[15%] translate-y-[0%]': isFocused, 'text-white text-base top-1/2 translate-y-[-50%]': !isFocused }">{{ label }}</label>
